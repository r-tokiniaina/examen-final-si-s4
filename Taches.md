...
# Version 3:
## Aléas 1
- [x] promotion en pourcentage sur le frais de transfert de meme operateur
- [x] base
- [x] Bonus: modifier le pourcentage

## Aléas 2
- [x] Notion d’épargne:
    - [x] le client choisit combien de % épargner
    - [x] pour chaque transfert, le % va en épargne
